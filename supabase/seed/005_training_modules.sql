...
VALUES (
  ...
  'The Design Intelligence Platform (DIP) replaces the static PDF binders that used to hold the health system''s design standards. Room data sheets, finish schedules, equipment schedules, and furniture/FF&E schedules now live in one searchable, always-current place.
