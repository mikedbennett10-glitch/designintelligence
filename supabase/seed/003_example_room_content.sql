...
BEGIN
  ...
  INSERT INTO finishes (code, guideline_scope, product_type, description, manufacturer, product_name, color, edition_id) VALUES
    ...
    ('RFT-2', 'AMBULATORY', 'Resilient Floor Tile', 'Accent / wayfinding flooring at arrival and transitions.',          'Example Manufacturer Co.', 'Example LVT Collection', 'Brand Blue Accent', v_edition_id),
