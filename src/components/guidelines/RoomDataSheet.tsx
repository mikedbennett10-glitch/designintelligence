...
function Badge({
  ...
  const styles = {
    blue: { bg: "var(--brand-blue-lt)", fg: "var(--brand-blue-dk)" },
    pink: { bg: "var(--brand-pink-lt)", fg: "var(--brand-pink)" },
    neutral: { bg: "var(--brand-charcoal-lt)", fg: "var(--muted)" },
  }[tone];
  return (
    <span
      style={{
          ...
          return (
            <button
              ...
              style={{
                ...
                color: active ? "var(--brand-blue-dk)" : "var(--muted)",
            ...
            {decisionLogic.length === 0 ? (
              ...
              decisionLogic.map((d) => (
                <div key={d.id} style={{ marginBottom: "1rem" }}>
                  {d.category && (
                    <div style={{ fontSize: "0.75rem", fontWeight: 700, color: "var(--brand-blue-dk)", marginBottom: "0.2rem" }}>
                      {d.category}
                    </div>
                  )}
