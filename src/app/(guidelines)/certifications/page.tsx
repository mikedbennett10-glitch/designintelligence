                ...
                <div style={{ flexShrink: 0, display: "flex", alignItems: "center", gap: "0.75rem" }}>
                  <span
                    style={{
                      ...
                      borderRadius: "999px",
                      background: done ? "var(--brand-blue-lt)" : "var(--brand-charcoal-lt)",
                      color: done ? "var(--brand-blue-dk)" : "var(--muted)",
                    }}
                  >
                    {done
                  ...
                  <Link
                    ...
                    style={{ fontSize: "0.8rem", fontWeight: 600, color: "var(--brand-blue-dk)" }}
                  >
