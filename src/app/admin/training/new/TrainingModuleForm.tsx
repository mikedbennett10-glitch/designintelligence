...
export default function TrainingModuleForm() {
  ...
  return (
    <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
        ...
        {requirements.map((r, i) => (
          <div key={i} style={{ ...cardStyle, display: "flex", gap: "0.6rem", alignItems: "center", flexWrap: "wrap" }}>
            ...
            <button
              ...
              style={{ marginLeft: "auto", border: "none", background: "none", color: "var(--brand-pink)", cursor: "pointer", fontSize: "0.8rem" }}
            >
              Remove
            </button>
          </div>
          ...
          <div key={q.key} style={cardStyle}>
            <div style={{ display: "flex", gap: "0.5rem", marginBottom: "0.6rem" }}>
              ...
              <button
                ...
                style={{ flexShrink: 0, border: "none", background: "none", color: "var(--brand-pink)", cursor: "pointer", fontSize: "0.8rem" }}
              >
                Remove question
              </button>
            </div>
            ...
            <button
              ...
              style={{ fontSize: "0.78rem", border: "none", background: "none", color: "var(--brand-blue-dk)", cursor: "pointer", padding: 0 }}
            >
              + Add choice
            </button>
          </div>
      ...
      {result && (
        <p style={{ fontSize: "0.85rem", color: result.ok ? "var(--brand-blue-dk)" : "var(--brand-pink)" }}>
          {result.text}
        </p>
      )}
    </form>
